...
<!--
理論的には重視されていても、統計モデルの中で定量的に取り扱われないままとなる。結果として、分析が**「ブラックボックス化」**し、現実の社会構造や社会過程を捉えないことが批判されます。
-->
...
<!--
経験的社会科学は、個人属性や傾向の精緻な推定を可能にする一方で、人々の行動が社会的文脈や相互作用の中で形成されるという観点を見落としがちである。そのため、社会現象を理解するためには、構造や相互作用を取り入れた分析の視点が不可欠である。
-->
...
<!--
分析社会学は、「説明すべき社会現象を**メカニズム**によって解明する」という立場を取る。とくに、ミクロとマクロの連関に注目し、以下の三層構造で社会現象を分析する。
- 社会構造（例：制度、階層、文化的規範）は、個人の認知・態度・選好といったミクロ要因に作用する
- 個人の信念、欲求、社会関係、情報の受け取り方に基づいて、具体的な行為や相互作用が形成される
- 多数の個人の行動が相互作用し、集団的パターンや社会的帰結（新たな制度、慣習、格差など）が生成される

分析社会学は、「AがBを引き起こす」という単純な因果関係ではなく、「AがBを引き起こすのは、Cという仕組みを通じてである」という形で、中間メカニズムを明示することを目指す。
-->
